...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image:
        "https://media.licdn.com/dms/image/v2/D4D03AQEu5wmPaqT3qw/profile-displayphoto-shrink_400_400/B4DZQRryUvGgAg-/0/1735463480008?e=1741219200&v=beta&t=ypHWPr666o0BQh0s26MOnDuQe8TqOlG5bYljmu1RYLU",
    ...
    },
    {
      ...
      position: "Software Engineer",
      image:
        "https://media.licdn.com/dms/image/v2/D4D03AQGWR4S0URZ_VA/profile-displayphoto-shrink_400_400/B4DZQH2y6QHcAg-/0/1735298592930?e=1740614400&v=beta&t=_KSp1qM-2VYOvdFWeHW3K_vOysIKlM4FhAhhBwsVTLw",
  ...
  return (
    <section id="team" className="team">
      <h2>Our Team</h2>
      <p>
        We are always looking for the right talent to join us. If you're
        interested, check our openings.
      </p>
